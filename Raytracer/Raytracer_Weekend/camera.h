...
class camera {
        ...
        void render(const hittable& world) {
            ...
            for (int j = 0; j < image_height; j++) {
                ...
                for (int i = 0; i < image_width; i++) {
                    ...
                    write_color(std::cout, pixel_sample_scales * pixel_color);
                }
            }
    ...
    private:
        ...
        double pixel_sample_scales; // Color scale factor for a sum of pixel samples
        ...
        ray get_ray(int i, int j) const {
            // construck cam ray originating from origin and directly smapled
